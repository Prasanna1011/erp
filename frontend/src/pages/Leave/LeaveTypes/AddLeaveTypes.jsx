...
import { API_ADD_CLIENTS, API_ADD_HOLIDAY, API_ADD_LEAVE_TYPE } from "Apis/api"
...
const AddLeaveTypes = () => {
  ...
  document.title = "Add Leave Types | TechAstha";
  ...
  const validation = useFormik({
    ...
    onSubmit: async values => {
      try {
        const { data } = await axios.post(API_ADD_LEAVE_TYPE, values, config)
