...
import {
  ...
  API_GET_LEAVE_TYPE,
  API_GET_USERS,
  GET_PARTICULAR_USER_LEAVE_HISTORY,
} from "Apis/api.js";
...
const AddLeaves = () => {
  ...
  document.title = "Add Leaves | TechAstha";
                ...
                <Card>
                  <div className="table-responsive">
                    <Table className="align-middle ">
                      ...
                      <tbody>
                        {leaveHistory &&
                          leaveHistory.map((eachItem, index) => (
                            <tr key={index}>
                              <td className="text-center">{eachItem.Type}</td>
                              <td className="text-center">
                                {eachItem.Allowed}
                              </td>
                              <td className="text-center">{eachItem.Used}</td>
                              <td className="text-center">
                                {eachItem.Remaining}
                              </td>
                            </tr>
                  ...
                  <div className="table-responsive">
                    <Table className="align-middle ">
                      <thead className="table-light">
                        <tr>
                          {leaveHistory &&
                            leaveHistory.map((eachItem) => (
                              <th className="text-center">{eachItem.Type}</th>
                            ))}
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          {leaveHistory &&
                            leaveHistory.map((eachItem) => (
                              <th className="text-center">{eachItem.Extra}</th>
                            ))}
                        </tr>
                      </tbody>
                    </Table>
