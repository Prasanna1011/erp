...
//                     <thead>
//                       <tr>
//                         <th scope="col" style={{ width: "100px" }} className="text-center">
//                           #
//                         </th>
//                         <th scope="col" className="text-center">Projects</th>
...
//                             </p>
//                           </td>
//                           <td className="text-center"> {handleValidDate(project.dueDate)}</td>
//                           <td className="text-center">
