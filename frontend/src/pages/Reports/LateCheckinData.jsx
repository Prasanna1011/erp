...
import { API_GET_CHAT_USERS_LIST, API_GET_USERS, API_LATE_CHECKIN_DATA } from "Apis/api";
...
const LateCheckinData = () => {
  ...
  document.title = "Late Check-Ins | Tech Astha-Portal";

  const config = GetAuthToken();

  const getLateCheckinData = async () => {
    try {
      setLoading(true)
      const { data } = await axios.get(
        `${API_LATE_CHECKIN_DATA}?employee_id=${employeeId}&date=${date}&page=${pageNumber}&page_size=${pageSize}&from_date=${fromDate}&to_date=${toDate}`,
        config
      );
      setLateCheckins(data.results);
      setLoading(false)
              ...
              <CardBody>
                ...
                >
                  ...
                  <Table className="align-middle ">
                    ...
                    <tbody>
                      {lateCheckins &&
                        lateCheckins.map((eachItem, index) => (
                          <tr key={index}>
                            ...
                            <td className="text-center">
                              {eachItem?.checkin_time ? new Date(
                            ...
                            <td className="text-center">
                              {eachItem?.checkout_time ? new Date(
...
export default LateCheckinData;